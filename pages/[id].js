...
const Movie = ({ movie, movieCred, movieRating }) => {
...
export const getServerSideProps = async (context) => {
  ...
  const fetchMovie = await fetch(
    `https://api.themoviedb.org/3/movie/${id}?api_key=5ccd6301393b904c4b1b8e5b00f12401&language=en-US`,
    requestOptions
  );
  const movie = await fetchMovie.json();
  const fetchMovieCred = await fetch(
    `https://api.themoviedb.org/3/movie/${id}/credits?api_key=5ccd6301393b904c4b1b8e5b00f12401&language=en-US`,
    requestOptions
  );
  const movieCred = await fetchMovieCred.json();
  const fetchMovieRat = await fetch(
    `https://api.themoviedb.org/3/movie/${id}/reviews?api_key=5ccd6301393b904c4b1b8e5b00f12401&language=en-US`,
    requestOptions
  );
  const movieRating = await fetchMovieRat.json();
  return {
    props: { movie, movieCred, movieRating },
  };
};
